class Api::V1::SpiritualJourneyPolicy < Api::V1::ApplicationPolicy
  ...
  def create?
    ...
    user.super_admin? or user.digital_store_admin? or user.sadhak_profile == spiritual_journey.sadhak_profile or user.sadhak_profiles.include?(spiritual_journey.sadhak_profile)
  end
